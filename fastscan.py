...
from lib.alive_scan import arp_ping,icmp_ping,alive_scan
from lib.port_scan import scan_port  
from lib.get_ip_list import get_ip_list 
from lib.output import save_result,save_port,save2mongodb,web_info
import pdb  
                ...
                if i == speed:
                    ...
                    for task in tasks:
                        if task.result(): 
                            ...
                            if task.result()['banner'].startswith('HTTP'):
                                web_info(task.result())
